...
class kostal_modbusquery:
    def __init__(self):
        ...
        self.Adr[6]   = ["Inverter article number", "Strg8"]
        self.Adr[46]  = ["Software-Version IO-Controller (IOC)", "Strg8"]
        self.Adr[56]  = ["Inverter State", "U16"]
        self.Adr[100] = ["Total DC power", "Float"]

        self.Adr[104] = ["State of energy manager","Float"]
        self.Adr[106] = ["Home own consumption from battery", "Float"]

        self.Adr[108] = ["Home own consumption from grid", "Float"]
        self.Adr[110] = ["Total home consumption Battery", "Float"]

        self.Adr[112] = ["Total home consumption Grid", "Float"]
        self.Adr[114] = ["Total home consumption PV", "Float"]
        self.Adr[116] = ["Home own consumption from PV", "Float"]
        self.Adr[118] = ["Total home consumption", "Float"]
        self.Adr[120] = ["Isolation resistance", "Float"]
        self.Adr[122] = ["Power limit from EVU", "Float"]
        self.Adr[124] = ["Total home consumption rate", "Float"]
        self.Adr[144] = ["Worktime", "Float"]

        self.Adr[150] = ["Actual cos phi", "Float"]
        self.Adr[152] = ["Grid frequency", "Float"]
        self.Adr[154] = ["Current Phase 1", "Float"]
        self.Adr[156] = ["Active power Phase 1", "Float"]
        self.Adr[158] = ["Voltage Phase 1", "Float"]
        self.Adr[160] = ["Current Phase 2", "Float"]
        self.Adr[162] = ["Active power Phase 2", "Float"]
        self.Adr[164] = ["Voltage Phase 2", "Float"]
        self.Adr[166] = ["Current Phase 3", "Float"]

        self.Adr[168] = ["Active power Phase 3", "Float"]
        self.Adr[170] = ["Voltage Phase 3", "Float"]
        self.Adr[172] = ["Total AC active power", "Float"]
        self.Adr[174] = ["Total AC reactive power", "Float"]
        self.Adr[178] = ["Total AC apparent power", "Float"]
        self.Adr[190] = ["Battery charge current", "Float"]
        self.Adr[194] = ["Number of battery cycles", "Float"]
        self.Adr[200] = ["Actual battery charge -minus or discharge -plus current", "Float"]
        self.Adr[202] = ["PSSB fuse state", "Float"]
        self.Adr[208] = ["Battery ready flag", "Float"]
        self.Adr[210] = ["Act. state of charge", "Float"]
        # self.Adr[212] = ["Battery state", "Float"]
        self.Adr[214] = ["Battery temperature", "Float"]
        self.Adr[216] = ["Battery voltage", "Float"]
        self.Adr[218] = ["Cos phi (powermeter)", "Float"]
        self.Adr[220] = ["Frequency (powermeter)", "Float"]
        self.Adr[222] = ["Current phase 1 (powermeter)", "Float"]
        self.Adr[224] = ["Active power phase 1 (powermeter)", "Float"]
        self.Adr[226] = ["Reactive power phase 1 (powermeter)", "Float"]
        self.Adr[228] = ["Apparent power phase 1 (powermeter)", "Float"]
        self.Adr[230] = ["Voltage phase 1 (powermeter)", "Float"]
        self.Adr[232] = ["Current phase 2 (powermeter)", "Float"]
        self.Adr[234] = ["Active power phase 2 (powermeter)", "Float"]
        self.Adr[236] = ["Reactive power phase 2 (powermeter)", "Float"]
        self.Adr[238] = ["Apparent power phase 2 (powermeter)", "Float"]
        self.Adr[240] = ["Voltage phase 2 (powermeter)", "Float"]
        self.Adr[242] = ["Current phase 3 (powermeter)", "Float"]
        self.Adr[244] = ["Active power phase 3 (powermeter)", "Float"]
        self.Adr[246] = ["Reactive power phase 3 (powermeter)", "Float"]
        self.Adr[248] = ["Apparent power phase 3 (powermeter)", "Float"]
        self.Adr[250] = ["Voltage phase 3 (powermeter)", "Float"]
        self.Adr[252] = ["Total active power (powermeter)", "Float"]
        self.Adr[254] = ["Total reactive power (powermeter)", "Float"]
        self.Adr[256] = ["Total apparent power (powermeter)", "Float"]
        self.Adr[258] = ["Current DC1", "Float"]
        self.Adr[260] = ["Power DC1", "Float"]
        self.Adr[266] = ["Voltage DC1", "Float"]
        self.Adr[268] = ["Current DC2", "Float"]
        self.Adr[270] = ["Power DC2", "Float"]
        self.Adr[276] = ["Voltage DC2", "Float"]
        self.Adr[278] = ["Current DC3", "Float"]
        self.Adr[280] = ["Power DC3", "Float"]
        self.Adr[286] = ["Voltage DC3", "Float"]
        self.Adr[320] = ["Total yield", "Float"]
        self.Adr[322] = ["Daily yield", "Float"]
        self.Adr[324] = ["Yearly yield", "Float"]
        self.Adr[326] = ["Monthly yield", "Float"]
        self.Adr[512] = ["Battery Gross Capacity", "U32"]
        self.Adr[514] = ["Battery actual SOC", "U16"]
        self.Adr[515] = ["Firmware Maincontroller (MC)", "U32"]
        self.Adr[517] = ["Battery Manufacturer", "Strg8"]
        self.Adr[525] = ["Battery Model ID", "U32"]
        self.Adr[527] = ["Battery Serial Number", "U32"]
        self.Adr[529] = ["Battery Operation mode", "U32"]
        ...
        self.Adr[588] = ["Battery Type", "U16"]
        self.Adr[768] = ["Productname", "Strg32"]
        self.Adr[800] = ["Power Class", "Strg32"]
        self.Adr[1024] = ["Battery charge power (AC) setpoint", "S16"]
        self.Adr[1025] = ["Power Scale Factor", "S16"]
        self.Adr[1026] = ["Battery charge power (AC) setpoint, absolute", "R32"]
        self.Adr[1028] = ["Battery charge current (DC) setpoint, relative", "R32"]
        self.Adr[1030] = ["Battery charge power (AC) setpoint, relative", "R32"]
        self.Adr[1032] = ["Battery charge current (DC) setpoint, absolute", "R32"]
        self.Adr[1034] = ["Battery charge power (DC) setpoint, absolute", "R32"]
        self.Adr[1036] = ["Battery charge power (DC) setpoint, relative", "R32"]
        self.Adr[1038] = ["Battery max charge power limit, absolute", "U32"]
        self.Adr[1040] = ["Battery max discharge power limit, absolute", "U32"]
        self.Adr[1042] = ["Minimum SOC", "U32"]
        self.Adr[1044] = ["Maximum SOC", "U32"]
        self.Adr[1046] = ["Total DC charge energy (DC-side to battery)", "R32"]
        self.Adr[1048] = ["Total DC discharge energy (DC-side from battery)", "R32"]
        self.Adr[1050] = ["Total AC charge energy (AC-side to battery)", "R32"]
        self.Adr[1052] = ["Total AC discharge energy (Battery to grid)", "R32"]
        self.Adr[1054] = ["Total AC charge energy (grid to battery)", "R32"]
        self.Adr[1056] = ["Total DC PV energy (sum of all PV inputs)", "R32"]
        self.Adr[1058] = ["Total DC energy from PV1", "R32"]
        self.Adr[1060] = ["Total DC energy from PV2", "R32"]
        self.Adr[1062] = ["Total DC energy from PV3", "R32"]
        self.Adr[1064] = ["Total energy AC-side to grid", "R32"]
        self.Adr[1066] = ["Total DC power (sum of all PV inputs)", "R32"]
        self.Adr[1068] = ["Battery work capacity", "R32"]
        self.Adr[1070] = ["Battery serial number", "U32"]
        self.Adr[1076] = ["Maximum charge power limit (readout from battery)", "R32"]
        self.Adr[1078] = ["Maximum discharge power limit (readout from battery)", "R32"]
        self.Adr[1080] = ["Battery management mode", "U8"]
        self.Adr[1082] = ["Installed sensor type", "U8"]
    ...
    def run(self):
        ...
        try:
            ...
            if self.Adr[575][2] > 32766: #Sometimes we hit the max value of 32767 - which implies a zero value
                self.Adr[575][2] = 0
